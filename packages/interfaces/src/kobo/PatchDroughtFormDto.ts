import { IsDateString, IsIn, IsNumberString, IsOptional, IsString, Length } from 'class-validator';

export class PatchDroughtFormDto {
  @IsOptional() @IsString() readonly 'group_ve4vz14/q_Enum'!: string;
  @IsOptional() @IsDateString() readonly 'group_ve4vz14/Date_report'!: string;
  @IsOptional() @IsString() readonly 'group_ve4vz14/q_Funtion'!: string;
  @IsOptional() @IsString() readonly 'group_ve4vz14/q_Phone'!: string;
  @IsOptional() @IsString() @Length(2) readonly 'group_yu9nq00/Province'!: string;
  @IsOptional() @IsString() @Length(4) readonly 'group_yu9nq00/District'!: string;
  @IsOptional() @IsString() @Length(6) readonly 'group_yu9nq00/Commune'!: string;
  @IsOptional() @IsDateString() readonly 'group_yu9nq00/Date_Dis': string;
  @IsOptional() @IsNumberString() readonly 'group_yu9nq00/DisTyp'!: string;
  ...
  @IsOptional() @IsIn(['1', '2']) readonly 'group_em29q27/group_oh4fa74/Electric'?: string;
  ...
  @IsOptional() @IsIn(['1', '2']) readonly 'group_em29q27/group_mv5vw26/ElecForHeal'?: string;
  ...
  @IsOptional() @IsIn(['1', '2']) readonly 'group_hp5cn05/NuKidColWat'?: string;
  @IsOptional() @IsIn(['1', '2']) readonly 'group_hp5cn05/IfYes'?: string;
  @IsOptional() @IsIn(['1', '2']) readonly 'group_hp5cn05/NuWoCollWat'?: string;
  @IsOptional() @IsIn(['1', '2']) readonly 'group_hp5cn05/Yes'?: string;
  @IsOptional() @IsIn(['1', '2']) readonly 'group_hp5cn05/TreatOccur'?: string;
}
