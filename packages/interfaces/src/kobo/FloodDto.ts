...
export class FloodDto {
  ...
  @IsOptional() @IsNumberString() readonly 'g11/ToNamAgriAff'?: string;
  @IsOptional() @IsNumberString() readonly 'g11/NumFarmCroAff'?: string;
  @IsOptional() @IsNumberString() readonly 'g11/Crop/FarmAff'?: string;
  @IsOptional() @IsNumberString() readonly 'g11/Crop/FarmDam'?: string;
  @IsOptional() @IsNumberString() readonly 'g11/NumFarmPaddyAff'?: string;
